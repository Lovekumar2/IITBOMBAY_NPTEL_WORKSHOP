...
ARCHITECTURE structure OF Traffic_1 IS
...
-- Equation(s):
-- \TIME2|Equal0~7\ = (\TIME2|count\(4) & (\TIME2|count\(3) & (D1_count[5] & \TIME2|count\(2))))
...
-- Equation(s):
-- \TIME2|Equal0~6\ = (!\TIME2|count\(7) & (!\TIME2|count\(8) & (D1_count[6] & \TIME2|count\(9))))
...
-- Equation(s):
-- \TIME2|count\(8) = DFFEAS((((\TIME2|Add0~120_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~5\ = (!\TIME2|count\(10) & (\TIME2|count\(13) & (!D1_count[11] & \TIME2|count\(12))))
...
-- Equation(s):
-- \TIME2|Equal0~4\ = (!\TIME2|count\(14) & (\TIME2|count\(17) & (!D1_count[16] & \TIME2|count\(15))))
...
-- Equation(s):
-- \TIME2|count\(17) = DFFEAS((((\TIME2|Add0~70_combout\ & !\TIME2|Equal0~9\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|count\(23) = DFFEAS((!\TIME2|Equal0~9\ & (((\TIME2|Add0~35_combout\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~2\ = (\TIME2|count\(23) & (\TIME2|count\(25) & (!D1_count[24] & \TIME2|count\(22))))
...
-- Equation(s):
-- \TIME2|Equal0~8_combout\ = (\TIME2|Equal0~5\ & (\TIME2|Equal0~4\ & (\TIME2|Equal0~7\ & \TIME2|Equal0~6\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \TIME2|Equal0~5\,
	datab => \TIME2|Equal0~4\,
	datac => \TIME2|Equal0~7\,
	datad => \TIME2|Equal0~6\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \TIME2|count\(26) = DFFEAS((!\TIME2|Equal0~9\ & (((\TIME2|Add0~5_combout\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|count\(27) = DFFEAS(((\TIME2|Add0~0_combout\ & ((!\TIME2|Equal0~9\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|count\(30) = DFFEAS((((\TIME2|Add0~25_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|count\(10) = DFFEAS(GND, GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , \TIME1|Add0~115_combout\, , , VCC)
...
-- Equation(s):
-- \TIME1|Equal0~6\ = (\TIME1|count\(13) & (\TIME1|count\(12) & (!C1_count[11] & !\TIME1|count\(10))))
...
-- Equation(s):
-- \TIME1|count\(13) = DFFEAS((((\TIME1|Add0~100_combout\ & !\TIME1|Equal0~10\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~5\ = (\TIME1|count\(17) & (\TIME1|count\(14) & (!C1_count[16] & \TIME1|count\(15))))
...
-- Equation(s):
-- \TIME1|count\(17) = DFFEAS(((\TIME1|Add0~80_combout\ & ((!\TIME1|Equal0~10\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~4\ = (\TIME1|count\(20) & (\TIME1|count\(19) & (!C1_count[18] & \TIME1|count\(21))))
...
-- Equation(s):
-- \TIME1|Equal0~3\ = (\TIME1|count\(22) & (\TIME1|count\(23) & (!C1_count[24] & \TIME1|count\(25))))
...
-- Equation(s):
-- \TIME1|count\(26) = DFFEAS(GND, GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , \TIME1|Add0~25_combout\, , , VCC)
...
-- Equation(s):
-- \TIME1|Equal0~1\ = (!\TIME1|count\(27) & (!\TIME1|count\(26) & (!C1_count[29] & !\TIME1|count\(28))))
...
-- Equation(s):
-- \TIME1|Add0~30_combout\ = ((\TIME1|Add0~37\ $ (\TIME1|count\(31))))
...
-- Equation(s):
-- \TIME1|Equal0~9_combout\ = (\TIME1|Equal0~5\ & (\TIME1|Equal0~7\ & (\TIME1|Equal0~8\ & \TIME1|Equal0~6\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \TIME1|Equal0~5\,
	datab => \TIME1|Equal0~7\,
	datac => \TIME1|Equal0~8\,
	datad => \TIME1|Equal0~6\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \TIME1|count\(22) = DFFEAS((((\TIME1|Add0~50_combout\ & !\TIME1|Equal0~10\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \Selector0~0_combout\ = (((\Y_Present.S7~regout\ & \TIME1|S1~regout\)))
...
-- Equation(s):
-- \Y_Present.S1~regout\ = DFFEAS((\TIME2|S1~regout\ & ((\Y_Present.S0~regout\) # ((\Y_Present.S1~regout\ & !\TIME1|S1~regout\)))) # (!\TIME2|S1~regout\ & (\Y_Present.S1~regout\ & ((!\TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, 
-- )
...
-- Equation(s):
-- \Y_Present.S2~regout\ = DFFEAS((\TIME2|S1~regout\ & (\Y_Present.S1~regout\ & ((\TIME1|S1~regout\)))) # (!\TIME2|S1~regout\ & ((\Y_Present.S2~regout\) # ((\Y_Present.S1~regout\ & \TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S3~regout\ = DFFEAS((\TIME2|S1~regout\ & ((\Y_Present.S2~regout\) # ((!\TIME1|S1~regout\ & \Y_Present.S3~regout\)))) # (!\TIME2|S1~regout\ & (!\TIME1|S1~regout\ & ((\Y_Present.S3~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, 
-- )
...
-- Equation(s):
-- \Y_Present.S4~regout\ = DFFEAS((\TIME1|S1~regout\ & ((\Y_Present.S3~regout\) # ((\Y_Present.S4~regout\ & !\TIME2|S1~regout\)))) # (!\TIME1|S1~regout\ & (((\Y_Present.S4~regout\ & !\TIME2|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, 
-- )
...
-- Equation(s):
-- \Y_Present.S5~regout\ = DFFEAS((\Y_Present.S5~regout\ & (((\TIME2|S1~regout\ & \Y_Present.S4~regout\)) # (!\TIME1|S1~regout\))) # (!\Y_Present.S5~regout\ & (\TIME2|S1~regout\ & (\Y_Present.S4~regout\))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \inst1|Mux1~0_combout\ = (!\Y_Present.S2~regout\ & (((\Y_Present.S1~regout\) # (\Y_Present.S3~regout\)) # (!\Y_Present.rst~regout\)))
...
-- Equation(s):
-- \inst0|Mux1~0_combout\ = (!\Y_Present.S0~regout\ & (((\Y_Present.S7~regout\) # (\Y_Present.S1~regout\)) # (!\Y_Present.rst~regout\)))

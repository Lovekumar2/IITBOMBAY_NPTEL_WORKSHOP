...
SIGNAL \dut_instance|add_instance|inst4|inst3|inst4|Y~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst4|inst3|inst4|Y~1\ : std_logic;
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|inst4|inst3|inst4|Y~1\)))) # (!\shift_reg~2_combout\ & (datau(3) & ((!\shift_reg~3_combout\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => datau(3),
	datab => \dut_instance|add_instance|inst4|inst3|inst4|Y~1\,
...
\data[17]\ : maxv_lcell
-- Equation(s):
-- data(17) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~1_combout\, 
...
\data[9]\ : maxv_lcell
-- Equation(s):
-- data(9) = DFFEAS((((data(10)))), GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~1_combout\, , , , )
...
-- Equation(s):
-- dut_input(16) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, data(16), , , 
-- VCC)
...
-- Equation(s):
-- dut_input(4) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, data(4), , , 
-- VCC)
...
-- Equation(s):
-- \datau[2]~7\ = (dut_input(0) & (((dut_input(1))))) # (!dut_input(0) & ((dut_input(1) & ((dut_input[12]))) # (!dut_input(1) & (dut_input(4)))))
...
-- Equation(s):
-- \datau[1]~5\ = (\datau[1]~4\ & ((dut_input(15)) # ((!dut_input(1))))) # (!\datau[1]~4\ & (((dut_input[11] & dut_input(1)))))
...
-- Equation(s):
-- \datau[0]~0\ = (dut_input(0) & (((dut_input(1))))) # (!dut_input(0) & ((dut_input(1) & ((dut_input[10]))) # (!dut_input(1) & (dut_input(2)))))
...
-- Equation(s):
-- dut_input(14) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, data(14), , , 
-- VCC)
...
-- Equation(s):
-- \datau[0]~1\ = (\datau[0]~0\ & ((dut_input(14)) # ((!dut_input(0))))) # (!\datau[0]~0\ & (((dut_input[6] & dut_input(0)))))
...
-- Equation(s):
-- \dut_instance|add_instance|inst4|inst3|inst4|Y~0\ = (dut_input(0) & (((dut_input[9]) # (dut_input(1))))) # (!dut_input(0) & (dut_input(5) & ((!dut_input(1)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst4|inst3|inst4|Y~0\,
	regout => dut_input(9));

-- Location: LC_X5_Y4_N1
\dut_input[13]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst4|inst3|inst4|Y~1\ = (\dut_instance|add_instance|inst4|inst3|inst4|Y~0\ & ((dut_input(17)) # ((!dut_input(1))))) # (!\dut_instance|add_instance|inst4|inst3|inst4|Y~0\ & (((dut_input[13] & dut_input(1)))))
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(17),
	datab => \dut_instance|add_instance|inst4|inst3|inst4|Y~0\,
	datac => data(13),
	datad => dut_input(1),
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst4|inst3|inst4|Y~1\,
	regout => dut_input(13));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|inst4|inst3|inst4|Y~1\,
	oe => VCC,

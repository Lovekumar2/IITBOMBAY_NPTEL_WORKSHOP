...
SIGNAL \dut_instance|add_instance|inst2|S~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst2|C~0\ : std_logic;
SIGNAL \datau[2]~6_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|inst3|C~0\ : std_logic;
SIGNAL \datau[2]~2\ : std_logic;
SIGNAL \datau[3]~10\ : std_logic;
SIGNAL \shift_reg~3_combout\ : std_logic;
SIGNAL \datau[0]~4_combout\ : std_logic;
...
SIGNAL \dut_instance|add_instance|inst8|Y~0\ : std_logic;
...
SIGNAL datau : std_logic_vector(4 DOWNTO 0);
...
\data[7]\ : maxv_lcell
-- Equation(s):
-- data(7) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~1_combout\, 
...
-- Equation(s):
-- \dut_instance|add_instance|inst2|C~0\ = (dut_input(1) & ((dut_input(5)) # ((dut_input[4] & dut_input(0))))) # (!dut_input(1) & (dut_input(5) & (dut_input[4] & dut_input(0))))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|inst2|C~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst2|C~0\,
	regout => dut_input(4));
...
-- Equation(s):
-- \dut_instance|add_instance|inst2|S~0\ = dut_input(5) $ (dut_input(1) $ (((dut_input(4) & dut_input[0]))))
-- dut_input(0) = DFFEAS(\dut_instance|add_instance|inst2|S~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst2|S~0\,
	regout => dut_input(0));
...
-- Equation(s):
-- \datau[2]~2\ = (!\dut_instance|add_instance|inst2|S~0\ & (\dut_instance|add_instance|inst2|C~0\ $ (dut_input[6] $ (!dut_input(2)))))
-- dut_input(6) = DFFEAS(\datau[2]~2\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, 
-- data(6), , , VCC)
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst2|S~0\,
	datab => \dut_instance|add_instance|inst2|C~0\,
	datac => data(6),
	datad => dut_input(2),
	aclr => GND,
	sload => VCC,
...
-- Equation(s):
-- \dut_instance|add_instance|inst3|C~0\ = (dut_input(6) & ((\dut_instance|add_instance|inst2|C~0\) # ((dut_input[2])))) # (!dut_input(6) & (\dut_instance|add_instance|inst2|C~0\ & (dut_input[2])))
-- dut_input(2) = DFFEAS(\dut_instance|add_instance|inst3|C~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst3|C~0\,
	regout => dut_input(2));

-- Location: LC_X6_Y5_N9
\datau[2]~6\ : maxv_lcell
-- Equation(s):
-- \datau[2]~6_combout\ = dut_input(2) $ (\dut_instance|add_instance|inst2|C~0\ $ (((!\dut_instance|add_instance|inst2|S~0\ & \dut_instance|add_instance|inst8|Y~0\))))
...
PORT MAP (
	dataa => \dut_instance|add_instance|inst2|S~0\,
	datab => dut_input(2),
	datac => \dut_instance|add_instance|inst2|C~0\,
	datad => \dut_instance|add_instance|inst8|Y~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \datau[3]~10\ = (dut_input(7) & (\dut_instance|add_instance|inst3|C~0\ $ (((\datau[2]~2\))))) # (!dut_input(7) & ((\dut_instance|add_instance|inst3|C~0\ & ((\datau[2]~2\))) # (!\dut_instance|add_instance|inst3|C~0\ & (dut_input[3] & !\datau[2]~2\))))
-- dut_input(3) = DFFEAS(\datau[3]~10\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, 
-- data(3), , , VCC)
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(7),
	datab => \dut_instance|add_instance|inst3|C~0\,
	datac => data(3),
	datad => \datau[2]~2\,
	aclr => GND,
	sload => VCC,
...
-- Equation(s):
-- \dut_instance|add_instance|inst8|Y~0\ = (dut_input(3) & (((dut_input[7]) # (\dut_instance|add_instance|inst3|C~0\)) # (!\datau[2]~2\))) # (!dut_input(3) & ((\datau[2]~2\ & (dut_input[7] & \dut_instance|add_instance|inst3|C~0\)) # (!\datau[2]~2\ & 
-- ((dut_input[7]) # (\dut_instance|add_instance|inst3|C~0\)))))
-- dut_input(7) = DFFEAS(\dut_instance|add_instance|inst8|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => \datau[2]~2\,
	datac => data(7),
	datad => \dut_instance|add_instance|inst3|C~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst8|Y~0\,
	regout => dut_input(7));
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((\shift_reg~2_combout\ & (((\dut_instance|add_instance|inst8|Y~0\)))) # (!\shift_reg~2_combout\ & (!\shift_reg~3_combout\ & (datau(4)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
\datau[0]~4\ : maxv_lcell
-- Equation(s):
-- \datau[0]~4_combout\ = (\io~regout\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\))) # 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \datau[0]~4_combout\);

-- Location: LC_X3_Y6_N1
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~2_combout\ & (\datau[3]~10\ $ (((dut_input(3)))))) # (!\shift_reg~2_combout\ & (((datau(4))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (\datau[2]~6_combout\ $ (((dut_input(6)))))) # (!\shift_reg~2_combout\ & (((datau(3))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst2|S~0\ $ (((\dut_instance|add_instance|inst8|Y~0\))))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\shift_reg~2_combout\ & (dut_input(0) $ (((dut_input(4)))))) # (!\shift_reg~2_combout\ & (((datau(1))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|inst8|Y~0\,
	oe => VCC,

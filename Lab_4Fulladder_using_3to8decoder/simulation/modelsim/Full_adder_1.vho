...
SIGNAL \dut_instance|add_instance|inst6|Y~0\ : std_logic;
...
-- Equation(s):
-- \datau[0]~0\ = ((dut_input(2) & ((dut_input[1]) # (dut_input(0)))) # (!dut_input(2) & (dut_input[1] & dut_input(0))))
-- dut_input(1) = DFFEAS(\datau[0]~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, 
-- data(1), , , VCC)
...
-- Equation(s):
-- \dut_instance|add_instance|inst6|Y~0\ = (dut_input(1) $ (dut_input[0] $ (dut_input(2))))
-- dut_input(0) = DFFEAS(\dut_instance|add_instance|inst6|Y~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst6|Y~0\,
	regout => dut_input(0));
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~3_combout\ & (\dut_instance|add_instance|inst6|Y~0\)) # (!\shift_reg~3_combout\ & (((!\shift_reg~2_combout\ & datau(1))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst6|Y~0\,
...
-- Equation(s):
-- \datau[0]~1_combout\ = ((\shift_reg~2_combout\ & ((datau(1)))) # (!\shift_reg~2_combout\ & (datau(0))))
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\shift_reg~3_combout\ & (\datau[0]~0\)) # (!\shift_reg~3_combout\ & (((\datau[0]~1_combout\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|inst6|Y~0\,
	oe => VCC,
